class HomeController < ApplicationController
  def index
    ...
    begin
      ...
      train_row = browser.div(css: '.num div', visible_text: /046\.*/).wait_until(&:present?).parent.wait_until(&:present?).parent.wait_until(&:present?)
      ...
      @third_class = @places_by_class[2].text
